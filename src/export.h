...
typedef struct GAMESAVE_s GAMESAVE_s, *PGAMESAVE_s;

typedef struct OPTIONSSAVE_s OPTIONSSAVE_s, *POPTIONSSAVE_s;

typedef struct CUSTOMISESAVE_s CUSTOMISESAVE_s, *PCUSTOMISESAVE_s;
...
struct GAMESAVE_s {
    ...
    uint coins;
    ushort completion; /* Created by retype action */
    ...
    struct CUSTOMISESAVE_s customizer;
    undefined field35_0x7c9f;
    void *missionSave; /* Created by retype action */
    char field37_0x7ca4[96];
    void *characterSave; /* Created by retype action */
